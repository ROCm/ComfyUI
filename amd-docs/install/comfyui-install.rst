...
This topic covers setup and install instructions to help you get started running ComfyUI.
...
- **GPU platform:** AMD Instinct™ MI355X
...
1. Pull the Docker image.
   ...
   .. code-block:: bash
      ...
      docker pull comfyui:comfyui-0.18.2.amd0_rocm7.2.0_ubuntu24.04
...
2. Start a Docker container using the image.
   ...
   .. code-block:: bash
      ...
      --ipc=host \
      -p 8188:8188 \
      comfyui:comfyui-0.18.2.amd0_rocm7.2.0_ubuntu24.04
...
1. Clone the `https://github.com/ROCm/comfyui <https://github.com/ROCm/comfyui>`__ repository.
...
This will pull the ``rocm/pytorch-training:v25.2`` image and install ComfyUI along with
the ComfyUI Node Manager, the rgthree-comfy custom nodes, and the required dependencies.
...
To verify that ComfyUI was was installed correctly, you can test ROCm PyTorch support.
